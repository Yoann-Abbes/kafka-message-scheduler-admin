...
case "$FILE_PATH" in
  *.go|*.js|*.ts|*.tsx|*.jsx|project.json|*.css|*.scss|*.html|*.vue|*.svelte|*.astro|*.sh|*.bash|*.zsh) echo "$FILE_PATH" >> "$ACCUMULATOR" ;;
esac
...
#
# Why hardcoded, not *.go|*.js|*.ts|*.tsx|*.jsx|project.json|*.css|*.scss|*.html|*.vue|*.svelte|*.astro|*.sh|*.bash|*.zsh? The TDD loop is universal for source languages —
